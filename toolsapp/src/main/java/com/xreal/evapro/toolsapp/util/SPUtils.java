 ...
 * sp的工具类
 * <p>
 * 直接 getInstance().xx 默认使用 NEBULA_APP 目录的缓存
 * <p>
 * 其他的目录可以使用 getInstance(NEBULA_DEMO).xx 来使用
 * </>
 */
public final class SPUtils {
     ...
     * 其他的缓存 目录
     */
    public static final String NEBULA_DEMO = "nebula_demo";
    ...
    public static SPUtils getInstance(String spName, final int mode) {
        if (isSpace(spName)) spName = NEBULA_APP;
